...
**Assumptions**: Management clusters send metrics via Prometheus `remote_write`. Self-managed Karpenter is the compute strategy. Raw retention is 90d; downsampled retention is 180d (5m) and 365d (1h).
