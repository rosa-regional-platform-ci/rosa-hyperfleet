...
For the RC, this also dumps the `kubernetes_resources` table from Aurora PostgreSQL — producing a tabular summary (`resource-summary.txt`) and a full JSON export of all resources (`resources-full.json`).
