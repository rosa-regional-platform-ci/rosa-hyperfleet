...
# state in provision-infra-mc.sh (Phase 1, RC account context) via S3 state
# download + jq. When empty (RC messaging not yet provisioned) the module is
# skipped and messaging falls back to 5-minute safety polling.
# =============================================================================
