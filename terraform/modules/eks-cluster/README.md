...
- **`karpenter-bootstrap` managed node group**: 2x m7i.xlarge nodes tainted `CriticalAddonsOnly=true:NoSchedule`. Hosts Karpenter controller, CoreDNS, and metrics-server.
