...
#
# Both specs and status tables use timestamp polling (ListSince) for change
# detection. DynamoDB Streams are no longer used.
# =============================================================================
...
# =============================================================================
# Specs Tables (read-only for the agent)
# =============================================================================
